                ...
                <div className={styles.about__inner}>
                    <h3 className={styles.about__title}>
                        ...
                        <p className={styles.about__text}>
                            Проживаю в Дніпрі. 19 років. Розробник Vue/React. Навчаюсь на реальному проекті вже 5 місяць. Закінчив коледж радіоелектроніки. Зараз навчаюся на інженера в ДНУ Дніпровська політехніка. Шукаю роботу!
                        </p>
